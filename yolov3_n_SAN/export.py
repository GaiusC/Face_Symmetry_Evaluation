...
Usage:
    $ python path/to/export.py --weights yolov3_n_SAN.pt --include torchscript onnx coreml saved_model pb tflite tfjs

Inference:
    $ python path/to/detect.py --weights yolov3_n_SAN.pt
                                         yolov3_n_SAN.onnx  (must export with --dynamic)
                                         yolov3_saved_model
                                         yolov3_n_SAN.pb
                                         yolov3_n_SAN.tflite
...
def run(data=ROOT / 'data/coco128.yaml',  # 'dataset.yaml path'
        weights=ROOT / 'yolov3_n_SAN.pt',  # weights path
