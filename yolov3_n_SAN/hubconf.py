...
Usage:
    import torch
    model = torch.hub.load('ultralytics/yolov3_n_SAN', 'yolov3_n_SAN')
"""
...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    Arguments:
        name (str): name of model, i.e. 'yolov3_n_SAN'
...
def yolov3(pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    return _create('yolov3_n_SAN', pretrained, channels, classes, autoshape, verbose, device)
...
def yolov3_spp(pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    return _create('yolov3_n_SAN-spp', pretrained, channels, classes, autoshape, verbose, device)
...
def yolov3_tiny(pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    return _create('yolov3_n_SAN-tiny', pretrained, channels, classes, autoshape, verbose, device)


if __name__ == '__main__':
    model = _create(name='yolov3_n_SAN-tiny', pretrained=True, channels=3, classes=80, autoshape=True, verbose=True)  # pretrained
